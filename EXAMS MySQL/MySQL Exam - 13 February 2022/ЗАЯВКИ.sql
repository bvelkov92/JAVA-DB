CREATE SCHEMA `exam_febr_13_2022`;
USE `exam_febr_13_2022`;
...
`published_at`
FROM `reviews`
WHERE `content` LIKE  LOWER('My%') AND length(`content`) >61
...
WHERE YEAR(`order_datetime`) < '2019-01-01 00:00:00'
